...
This section is the interactive browser for the OpenAPI spec bundled with [`PetstoreV2.jl`](../). The spec is committed at [`spec/openapi.json`](/openapi.json) and rendered with [`vitepress-openapi`](https://github.com/enzonotario/vitepress-openapi).
